...
export class SidebarComponent implements OnInit, AfterViewInit {
  ...
  {name:'Hàng hóa',url:'',icon:'signal',childs:[{name:'Quản lý đơn hàng',url:'/product/order'},{name:'Quản lý loại hàng',url:'/product/category'},{name:'Quản lý thương hiệu',url:'/product/brand'},{name:'Quản lý sản phẩm',url:'/product/product'}]}];
  constructor() { }
  ngOnInit(): void {
  }
  ngAfterViewInit() {
